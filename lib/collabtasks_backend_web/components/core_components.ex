defmodule CollabtasksBackendWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CollabtasksBackendWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CollabtasksBackendWeb.Gettext, "errors", msg, opts)
    end
  end
